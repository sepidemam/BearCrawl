...
/*	@BearFilter(regex = "menu-button")
	...
	@BearFilter(regex = "librar")
	public static Set<Label> FilterAnnunvioVendita25(LogLine logline) {
		Set<Label> result = new HashSet<Label>();
		result.add(new Label("library", 33L));
		return result;
	}
